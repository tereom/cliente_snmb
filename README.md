...
El cliente de captura se desarrolló usando el marco de trabajo [Web2py](http://www.web2py.com/). Sigue una estructura de 
Modelo-Vista-Controlador que se refleja en la estructura de carpetas.

Bajo el esquema de Web2py, el cliente de captura es una aplicación y todo el código desarrollado se engloba en la carpeta *cliente_web2py* con las 
(que se debe copiar dentro de *applications*) siguientes subcarpetas:
