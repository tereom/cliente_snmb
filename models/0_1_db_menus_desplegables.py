...
if db(db.Sitio_numero_opcion.id>0).count() == 0:
    ...
    db.Sitio_numero_opcion.insert(num_numero='2', nombre_numero='Centro')
    db.Sitio_numero_opcion.insert(num_numero='3', nombre_numero='Sitio 2')
    db.Sitio_numero_opcion.insert(num_numero='4', nombre_numero='Sitio 3')
    db.Sitio_numero_opcion.insert(num_numero='5', nombre_numero='Sitio 4')
