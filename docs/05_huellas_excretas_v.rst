...
Index1
------
A continuación describimos las clases utilizadas en el archivo *index1.html*, así como los identificadores asociados al código JavaScript. Éste corresponde a la vista *Transecto huellas y excretas*.
...
Index2
------
A continuación describimos las clases utilizadas en el archivo *index2.html*, así como los identificadores asociados al código JavaScript. Éste corresponde a la vista *Registros huellas y excretas*. 

Nota: Esta vista esta compuesta por dos secciones, en la primera (*Huellas y Excretas*) se ingresa la información de campo y la segunda *Revisión de registros* sirve para revisar la información guardada en la base de datos. Las clases, identificadores y validación de este documento corresponden a la sección de *Huellas y Excretas* mientras que la segunda sección se genera con la función *smartgrid* de Web2py.
...
* **tabla_hay_nombre_comun** y **tabla_hay_nombre_comun** sirven para las acciones fade-in/fade-out, esto es, controlan que los campos *Nombre común* y *Nombre científico* se desvanezcan o aparezcan de acuerdo a la información ingresada. También sirven para validar los campos.
...
La validación se lleva a cabo cuando se envía la forma.
	...
	+ La clase *obligatorio*, todos los campos con esta clase deben tener información.
	+ Se validan los campos *Nombre común* y *Nombre científico* ya que debe ingresar al menos uno de ellos. Para validar esto, primero se verifica que al menos uno de los dos campos esté palomeado usando *tabla_hay_nombre_comun* y *tabla_hay_nombre_cientifico*, después se verifica que si el campo se palomeó los campos Nombre común (id *tabla_nombre_comun*) y/o Nombre científico (id *tabla_nombre_cientifico*) contengan información.